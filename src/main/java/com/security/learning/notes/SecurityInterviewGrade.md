...
```textmate
SecurityFilterChain -> SecurityFilterChain is registered in Servlet Filter container
    contains
        many Filters
...
│
├── UsernamePasswordAuthenticationFilter -> done
...
- “Before I give this request to the DispatcherServlet, I have these filters that must process it, and who
process it -> Servlet Filter Container."
